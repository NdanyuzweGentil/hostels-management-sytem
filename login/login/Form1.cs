...
namespace login
{
    public partial class Form1 : Form
    {
        ...
        {
            connectionString = "server=localhost; Database=hostledb;Uid=root;Pwd=;";
        ...
        {
            var usernameText = textBox3.Text;
            var passwordText = textBox4.Text;
        ...
        {
            connectionString = "server=localhost; Database=hostelsdb;Uid=root;Pwd=;";
            connection = new MySqlConnection(connectionString);
            connection.Open();
        }
    }
